...
#include "../inc/platform/stuhfl_platform.h"
#include "../inc/stuhfl_helpers.h"
#include "../inc/stuhfl_log.h"

#if defined(WIN32) || defined(WIN64)
#include "../inc/stuhfl_bl_win32.h"
#elif defined(POSIX)
...
#else
    ret = STUHFL_F_Connect_iMXRT1052(device, br);

    // register operation handlers
    STUHFL_F_PlatformReset = STUHFL_F_Reset_iMXRT1052;
    STUHFL_F_PlatformDisconnect = STUHFL_F_Disconnect_iMXRT1052;

    STUHFL_F_PlatformSndRaw = STUHFL_F_SndRaw_iMXRT1052;
    STUHFL_F_PlatformRcvRaw = STUHFL_F_RcvRaw_iMXRT1052;

    STUHFL_F_PlatformSetDTR = STUHFL_F_SetDTR_iMXRT1052;
    STUHFL_F_PlatformGetDTR = STUHFL_F_GetDTR_iMXRT1052;
    STUHFL_F_PlatformSetRTS = STUHFL_F_SetRTS_iMXRT1052;
    STUHFL_F_PlatformGetRTS = STUHFL_F_GetRTS_iMXRT1052;
    STUHFL_F_PlatformSetTimeouts = STUHFL_F_SetTimeouts_iMXRT1052;
    STUHFL_F_PlatformGetTimeouts = STUHFL_F_GetTimeouts_iMXRT1052;
